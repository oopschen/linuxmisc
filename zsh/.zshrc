...
alias hdmi1off="xrandr --output HDMI-1 --off"
alias hdmi1on="xrandr --output HDMI-1 --auto --primary --above eDP1"
alias hdmi1mirror="xrandr --output HDMI-1 --auto --primary --same-as eDP1"
alias gw="./gradlew"
